...
const servicesData = [
    {
        ...
        icon: <BarChart3 className="w-14 h-14 text-red-500" />,
    },
    {
        id: "02",
        title: "Digital Marketing",
        subtitle: "Boost your brand visibility online",
        icon: <Users className="w-14 h-14 text-red-500" />,
    },
    {
        id: "03",
        title: "SEO & SEM",
        subtitle: "Increase organic traffic and paid conversions",
        icon: <Globe className="w-14 h-14 text-red-500" />,
    },
    {
        id: "04",
        title: "Data Analytics",
        subtitle: "Turn data into actionable insights",
        icon: <Target className="w-14 h-14 text-red-500" />,
    },
    {
        id: "05",
...
const WeOffer = () => {
    return (
        <section className="w-full py-10 md:py-32 bg-[#1c1f24] text-white">
            <div className="container mx-auto px-4">

                {/* Section Header */}
                <div className="md:flex justify-between items-center text-center md:text-start gap-20 mb-12 ">
                    <div>
                        <h4 className="text-red-500 tracking-widest text-sm font-semibold uppercase">
                            Our Expertise
                        </h4>
                    ...
                    <p className="text-gray-300 max-w-lg mt-10 md:mt-0">
