...
const GrowBusiness = () => {
    ...
    return (
        <section className="relative w-full h-[400px] md:h-[700px] flex items-center justify-center bg-gray-900">
            {/* Background Image */}
            <Image
                src={videobg}
            ...
            {/* Modal for Video */}
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 -top-2/3">
                    <div className="relative  h-[20] md:w-full max-w-4xl mx-4 md:mx-0">
                        <iframe
                            width="100%"
                            height="500"
                            src={videoUrl}
